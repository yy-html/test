...
const configR = merge(baseWebpackConfig, {
  ...
  output: {
    ...
    publicPath: config.microProd.outputPublicPath,
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      'process.env': JSON.stringify({
        "NODE_ENV": "production",
        "VUE_APP_API_ROOT": require('../config.prod.env').VUE_APP_API_ROOT,
        "VUE_APP_VERSION": require('../config.prod.env').VUE_APP_VERSION
      })
    }),
